...
@section('title', 'Kepala Sekolah Dashboard - E-Learning System')
@section('content')
    <div id="main">
        <header class="mb-3">
        ...
        <div class="page-heading">
            <h3>Kepala Sekolah Dashboard - {{ $user->name }}</h3>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <a href="{{route('raports.index')}}" class="btn btn-outline-primary btn-sm">
                                    <i class="bi bi-file-earmark-text"></i> View Reports
                                </a>
                                <a href="{{route('guru.index')}}" class="btn btn-outline-success btn-sm">
